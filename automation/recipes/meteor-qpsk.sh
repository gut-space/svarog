...
PRODUCT_FILENAME=${BASENAME}_product # Unknown extension
...
yes | meteor_demod -o $QPSK_FILENAME $SIGNAL_FILENAME
...
# Generate images
medet ${DUMP_PREFIX_FILENAME}.dec $PRODUCT_FILENAME -r 65 -g 65 -b 64 -d
